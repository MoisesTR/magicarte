...
export default function Footer() {
  return (
    <footer className='bg-gradient-to-r from-gray-800 via-gray-900 to-gray-800 py-8'>
        ...
        <div className='mb-6'>
          ...
          <div className='flex justify-center space-x-4 mb-4'>
            <a
              ...
              className='text-gray-400 hover:text-[#51c879] transition-colors duration-200'
            >
            ...
            <a
              ...
              target='_blank'
              rel='noopener noreferrer'
              className='text-gray-400 hover:text-[#50bfe6] transition-colors duration-200'
            >
              <svg className='w-6 h-6' fill='currentColor' viewBox='0 0 24 24'>
